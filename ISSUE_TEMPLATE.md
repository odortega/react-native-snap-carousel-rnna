...
- [] I have read [the guidelines regarding bug report](https://github.com/odortega/react-native-snap-carousel-rnna/blob/master/CONTRIBUTING.md).
- [] I have reviewed [the documentation](https://github.com/odortega/react-native-snap-carousel-rnna/blob/master/README.md) in its entirety, including the dedicated documentations :books:.
- [] I have searched for [existing issues](https://github.com/odortega/react-native-snap-carousel-rnna/issues) and made sure that the problem hasn't already been reported.
- [] I am using [the latest plugin version](https://github.com/odortega/react-native-snap-carousel-rnna/releases).
- [] I am following [the issue template](https://raw.githubusercontent.com/odortega/react-native-snap-carousel-rnna/master/ISSUE_TEMPLATE.md) closely in order to produce a useful bug report.
...
### Have you made sure that it wasn't a [React Native bug](https://github.com/odortega/react-native-snap-carousel-rnna/issues?utf8=%E2%9C%93&q=is%3Aissue+label%3A%22react-native+bug%22+)?
...
<!--
  Steps you should take:
    ...
    1. Take a look at plugin's issues that are [labelled `react-native bug`](https://github.com/odortega/react-native-snap-carousel-rnna/issues?utf8=%E2%9C%93&q=is%3Aissue+label%3A%22react-native+bug%22+)

    2. Search [React Native issues](https://github.com/facebook/react-native/issues)

    3. Read the following sections of the doc again: ["Known issues"](https://github.com/odortega/react-native-snap-carousel-rnna/blob/master/doc/KNOWN_ISSUES.md), ["Important note regarding Android"](https://github.com/odortega/react-native-snap-carousel-rnna#important-note-regarding-android), and ["Custom interpolations caveats"](https://github.com/odortega/react-native-snap-carousel-rnna/blob/master/doc/CUSTOM_INTERPOLATIONS.md#caveats).
 -->
...
<!--
  If you haven't been able to reproduce the bug in production mode, it probably has to do with React Native's limitations (see ["Known issues"](https://github.com/odortega/react-native-snap-carousel-rnna/blob/master/doc/KNOWN_ISSUES.md)). Chances are we won't be able to do anything about it.
-->
...
<!--
  ...
  Environment:
    React: 16.0.0-beta.5
    React native: 0.49.2
    react-native-snap-carousel-rnna: 3.3.4
